...
function BookmarkedProducts() {
  ...
  if (bookmarkedProducts.length === 0)
    return <Empty resourceName="هیچ محصول نشانک گزاری" />;
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        {bookmarkedProducts.map((product) => (
          <motion.div
            ...
            className="bg-secondary-0 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer group"
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div className="flex justify-between items-start gap-2">
                <h3 className="text-sm sm:text-base font-bold text-secondary-900 line-clamp-2 group-hover:text-primary-700 transition-colors">
                  {product.title}
                </h3>
